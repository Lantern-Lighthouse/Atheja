...
class Responsivity
{
     ...
     * 
     * @param string|array message The `message` parameter can accept either a string or an array.
     ...
     */
    public static function respond(string|array $message, int $code = \lib\Responsivity::HTTP_OK)
    {
